...
torchrun --standalone --nproc_per_node=$NPROC_PER_NODE -m scripts.base_train -- --depth=19 --target_param_data_ratio=20 --device_batch_size=2 --save_every=100 --run=$WANDB_RUN
